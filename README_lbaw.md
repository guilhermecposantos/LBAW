...
In this example, _$user_ and _$card_ are models that represent their respective tables, _$id_ and _$user_id_ are columns from those tables that are automatically mapped into those models.
